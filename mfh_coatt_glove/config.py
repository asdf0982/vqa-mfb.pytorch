...
DATA_PATHS = {
    'train': {
        ...
        'features_prefix': VQA_PREFIX + '/Features/ms_coco/%s/train2014/COCO_train2014_'%feat
    ...
    'val': {
        ...
        'features_prefix': VQA_PREFIX + '/Features/ms_coco/%s/val2014/COCO_val2014_'%feat
    ...
    'test-dev': {
        ...
        'features_prefix': VQA_PREFIX + '/Features/ms_coco/%s/test2015/COCO_test2015_'%feat
    ...
    'genome': {
        ...
        'features_prefix': VQA_PREFIX + '/Features/genome/%s/'%feat
...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--TRAIN_GPU_ID', type=int, default=2)
    ...
    parser.add_argument('--TESTDEV_INTERVAL', type=int, default=15000)
    ...
    parser.add_argument('--TRAIN_DATA_SPLITS', type=str, default='train+val')
    parser.add_argument('--QUESTION_VOCAB_SPACE', type=str, default='train+val')
    parser.add_argument('--ANSWER_VOCAB_SPACE', type=str, default='train+val')
